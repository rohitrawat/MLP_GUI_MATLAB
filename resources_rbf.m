...
switch(ID);
    case 'Info'
        value = {'RBF Training Program',
            '',
            'Algorithm: MULTI-KERNEL-MACHINE',
            '',
            'Author: Yilong Hao',
            '',
    ...
    case 'Nh'  % Row 6
        value = '';
    case 'Nit'  % Row 7
        value = 'Newton''s Iterations (Nit)';
    case 'weights_file'
        value = 'rbf_weights.txt';
    ...
    case 'FixedType'  % Disables Row 3
        value = 2;  % 0: user chooses file type, 1: fixed regression, 2: fixed classification
    case 'Extra'  % Row 8
